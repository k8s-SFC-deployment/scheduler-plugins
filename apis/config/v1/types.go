...
type NetworkTrafficArgs struct {
	...
	// NetworkInterface to be monitored, assume that nodes OS os homogeneous
...
// NetMarksArgs holds arguments used to configure NetMarks plugin
type NetMarksArgs struct {
	metav1.TypeMeta `json:",inline"`
