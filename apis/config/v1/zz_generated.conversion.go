...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NetMarksArgs)(nil), (*config.NetMarksArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NetMarksArgs_To_config_NetMarksArgs(a.(*NetMarksArgs), b.(*config.NetMarksArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NetMarksArgs)(nil), (*NetMarksArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NetMarksArgs_To_v1_NetMarksArgs(a.(*config.NetMarksArgs), b.(*NetMarksArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*RemoteScoringArgs)(nil), (*config.RemoteScoringArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_RemoteScoringArgs_To_config_RemoteScoringArgs(a.(*RemoteScoringArgs), b.(*config.RemoteScoringArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.RemoteScoringArgs)(nil), (*RemoteScoringArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_RemoteScoringArgs_To_v1_RemoteScoringArgs(a.(*config.RemoteScoringArgs), b.(*RemoteScoringArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_NetMarksArgs_To_config_NetMarksArgs(in *NetMarksArgs, out *config.NetMarksArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
...
// Convert_v1_NetMarksArgs_To_config_NetMarksArgs is an autogenerated conversion function.
func Convert_v1_NetMarksArgs_To_config_NetMarksArgs(in *NetMarksArgs, out *config.NetMarksArgs, s conversion.Scope) error {
	return autoConvert_v1_NetMarksArgs_To_config_NetMarksArgs(in, out, s)
}

func autoConvert_config_NetMarksArgs_To_v1_NetMarksArgs(in *config.NetMarksArgs, out *NetMarksArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
...
// Convert_config_NetMarksArgs_To_v1_NetMarksArgs is an autogenerated conversion function.
func Convert_config_NetMarksArgs_To_v1_NetMarksArgs(in *config.NetMarksArgs, out *NetMarksArgs, s conversion.Scope) error {
	return autoConvert_config_NetMarksArgs_To_v1_NetMarksArgs(in, out, s)
}
...
func autoConvert_v1_RemoteScoringArgs_To_config_RemoteScoringArgs(in *RemoteScoringArgs, out *config.RemoteScoringArgs, s conversion.Scope) error {
	if err := metav1.Convert_Pointer_string_To_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
...
// Convert_v1_RemoteScoringArgs_To_config_RemoteScoringArgs is an autogenerated conversion function.
func Convert_v1_RemoteScoringArgs_To_config_RemoteScoringArgs(in *RemoteScoringArgs, out *config.RemoteScoringArgs, s conversion.Scope) error {
	return autoConvert_v1_RemoteScoringArgs_To_config_RemoteScoringArgs(in, out, s)
}

func autoConvert_config_RemoteScoringArgs_To_v1_RemoteScoringArgs(in *config.RemoteScoringArgs, out *RemoteScoringArgs, s conversion.Scope) error {
	if err := metav1.Convert_string_To_Pointer_string(&in.Address, &out.Address, s); err != nil {
		return err
	}
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
...
// Convert_config_RemoteScoringArgs_To_v1_RemoteScoringArgs is an autogenerated conversion function.
func Convert_config_RemoteScoringArgs_To_v1_RemoteScoringArgs(in *config.RemoteScoringArgs, out *RemoteScoringArgs, s conversion.Scope) error {
	return autoConvert_config_RemoteScoringArgs_To_v1_RemoteScoringArgs(in, out, s)
}
